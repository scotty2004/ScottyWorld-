...
export const DEFAULT_FAQ: Array<{ question: string; answer: string; category: string }> = [
  ...
  { category: "Bots", question: "How does bot hosting work?", answer: "Every bot is hosted free for 7 days. After that, renew for 20 SC per week from the Bots page. If hosting ends, the bot is paused until you renew." },
